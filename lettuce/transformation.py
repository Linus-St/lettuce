...
class Transformation:
    ...
    def __init__(self, minimum_coarse: np.ndarray, maximum_coarse: np.ndarray, dimensions=2):
    ...
    def coarse_to_fine(self, coords: np.ndarray):
    ...
    def fine_input_valid(self, coords: np.ndarray):
    ...
    def coarse_input_valid(self, coords: np.ndarray):
    ...
    def coarse_as_fine_no_translation(self, coords: np.ndarray):
        return (coords * 2) - 1